...
INSERT INTO EMPREGADO (rua, numero, cep, complemento, cidade, estado, bairro, cpf, senha, nome) VALUES
        ('Chácara Chácara 133',   01, '72001825', '', 'Brasília', 'DF', 'Setor Habitacional Samambaia (Vicente Pires)', '31980230099', 'senhaForte', 'Allana Adriana Clarice Melo'),
        ...
        ('Quadra QBR 7 Bloco O', 04, '72594015', '', 'Brasília', 'DF', 'Residencial Santos Dumont (Santa Maria)', '42717809015', 'senhaForte', 'Jéssica Gabrielly Campos'),
        ('Quadra SHPS Quadra 106A', 05, '72238060', '', 'Brasília', 'DF', 'Setor Habitacional Pôr do Sol (Ceilândia)', '69867752023', 'senhaForte', 'Thomas Luan Sérgio dos Santos');
        ('Quadra QS 401 Conjunto H', 06, '72319528', '', 'Brasília', 'DF', 'Asa Norte', '39494937007', 'senhaForte', 'Vera Eduarda Alves');
        ('Área Especial SMDB Estação Ecológica Jardim Botânico de Brasília', 07, '71680001', '', 'Brasília', 'DF', 'Setor de Mansões Dom Bosco', '24645772007', 'senhaForte', 'Raquel Isabela Fogaça');
